    ...
    const startScanner = async () => {
      try {
        ...
        if (mounted) {
          ...
          setError('Camera access is required to scan frames. Please allow camera access and try again.');
        }
      }
    };
      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-foreground/80 text-base leading-relaxed max-w-[260px]">
            Point your camera at a frame&apos;s QR code
          </p>
        </div>

        {/* Skip CTA — matches landing button style */}
        <button
          onClick={handleSkipScan}
